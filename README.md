...
## Case
Desenvolver um e-commerce baseado em um [Figma](https://www.figma.com/file/O9AEeYB6ZWyMTZzMZhvjaY/loja-vtex-jussi?node-id=0%3A1) que cumpra as seguintes premissas:
...
## Sobre a solução
  - Foi biblioteca React com a framework [NextJS](https://nextjs.org/) para desenvolver a plataforma.
  ...
  - O valor retornado da API fica salvo no context do projeto.
